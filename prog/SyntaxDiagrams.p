...
procedure MakeDiagrams();
  ...
  begin
    ...
    gap2 := new Gap();
    diagram.AddShape(0, 2, gap2);
    objectTypeIdentifier := new RuleBox('object-type-identifier');
    diagram.AddShape(0, 3, objectTypeIdentifier);
    branch1 := new Branch();
    diagram.AddShape(0, 4, branch1);
    ...
    diagram.AddConnector(new SyntaxArrow(newKeyword, objectTypeIdentifier, east, noDir));
    diagram.AddConnector(new SyntaxArrow(objectTypeIdentifier, out, east, noDir));
  ...
  procedure MakeObjectTypeIdentifierDiagram();
  var
    title: DiagramTitle;
    diagram: Diagram;
    gap1, gap2: Gap;
    ...
    out: Out;
  begin
    title := new DiagramTitle('object-type-identifier');
    diagram := new Diagram(title, 'object-type-identifier.png');
    gap1 := new Gap();
    diagram.AddShape(0, 0, gap1);
    identifier := new RuleBox('identifier');
    diagram.AddShape(0, 1, identifier);
...
begin
  ...
  MakeObjectTypeIdentifierDiagram();
