...
{
    classElement, objectElement, noteElement, operationElement, fieldElement, relationshipElement
};
...
public:
    ...
    bool IsFieldElement() const { return kind == DiagramElementKind::fieldElement; }
