...
struct Selection
{
    ...
    soul::ast::SourcePos start;
    soul::ast::SourcePos end;
};
...
public:
    ...
    void ExtendSelection(const soul::ast::SourcePos& start, const soul::ast::SourcePos& end);
...
private:
    ...
    soul::ast::SourcePos mouseSelectionStart;
    soul::ast::SourcePos mouseSelectionEnd;
